...
To use these stylesheets, rename the files and my_bootstrap with the name of your theme.
...
my_bootstrap-alpha-default.css
...
my_bootstrap-alpha-default-narrow.css  
...
my_bootstrap-alpha-default-normal.css
...
my_bootstrap-alpha-default-wide.css
